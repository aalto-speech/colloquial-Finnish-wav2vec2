#!/bin/bash
#SBATCH --job-name=w2v2_L_0003   # Job name
#SBATCH --output=/fairseq_train_multinode_w2v2_L_512gpus_lr0003.o # Name of stdout output file
#SBATCH --error=/fairseq_train_multinode_w2v2_L_512gpus_lr0003.e  # Name of stderr error file
#SBATCH --partition=standard-g  # Partition (queue) name
#SBATCH --nodes=64            # Total number of nodes 
#SBATCH --ntasks-per-node=8     #
#SBATCH --cpus-per-task=7
#SBATCH --gpus-per-node=8
#SBATCH --time=0-13:50:00       # Run time (d-hh:mm:ss)
...
srun -N 64 --gpus 512 --ntasks-per-node=8 --cpus-per-task=7 --cpu-bind=mask_cpu:$MYMASKS \
/scripts/pretraining/fairseq_train_multinode_w2v2_L_512gpus_bash.sh
