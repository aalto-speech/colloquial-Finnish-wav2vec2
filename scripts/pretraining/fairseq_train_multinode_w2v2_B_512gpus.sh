#!/bin/bash
#SBATCH --job-name=w2v2_B_0006   # Job name
#SBATCH --output=/fairseq_train_multinode_w2v2_B_512gpus_lr0006.o # Name of stdout output file
#SBATCH --error=/fairseq_train_multinode_w2v2_B_512gpus_lr0006.e  # Name of stderr error file
...
/scripts/pretraining/fairseq_train_multinode_w2v2_B_512gpus_bash.sh
