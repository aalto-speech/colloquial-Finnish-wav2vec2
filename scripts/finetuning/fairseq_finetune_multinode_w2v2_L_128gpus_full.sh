...
#SBATCH --output=/fairseq_train_multinode_w2v2_L_scratch_128gpus_3e-4.o # Name of stdout output file
#SBATCH --error=/fairseq_train_multinode_w2v2_L_scratch_128gpus_3e-4.e  # Name of stderr error file
